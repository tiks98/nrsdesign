				...
				<section className="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
					...
					<div
						...
						<p className="mb-8 leading-relaxed text-gray-500 md:mb-12 lg:w-4/5 xl:text-lg">
							...
							experience. Every pixel is thoughtfully placed to enhance
							usability and leave a lasting impression. Let’s bring your vision
							to life with designs that are not only beautiful but also
							functional.
						</p>
					</div>
				</section>
				...
				<section className="flex flex-col justify-around gap-2 sm:gap-5 md:gap-8 lg:flex-row">
					<div
						...
						<p className="mb-8 leading-relaxed text-gray-500 md:mb-12 lg:w-4/5 xl:text-lg">
							...
							flexibility. With a focus on speed, security, and performance, we
							build websites that are fast, reliable, and ready to handle any
							challenge. Let’s develop something exceptional—where innovation
							meets efficiency.
						</p>
					</div>
					<div
				...
				<section className="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
					...
					<div
						...
						<p className="mb-8 leading-relaxed text-gray-500 md:mb-12 lg:w-4/5 xl:text-lg">
							...
							you can focus on what matters most—your business. Let’s launch
							your vision with confidence and precision.
						</p>
					</div>
				</section>
			</div>
				...
				<section className="flex flex-col justify-around gap-6 sm:gap-10 md:gap-16 lg:flex-row">
					<div
						...
						<p className="mb-8 leading-relaxed text-gray-500 md:mb-12 lg:w-4/5 xl:text-lg">
							...
							ongoing optimization to keep your platform fast, secure, and up to
							date. We’ve got your back—so you can focus on growing your
